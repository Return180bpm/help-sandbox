...
1.   *Finalizing the UI design was a turning point in this project (thank you, Gi).*
...
2.   *Narrowing the scope would have saved me some frustration*
...
3.   *Design doesn't just mean appearance*
